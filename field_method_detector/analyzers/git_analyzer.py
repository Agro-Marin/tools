...
class GitAnalyzer:
    ...
    def resolve_commits(self, commit_from: Optional[str] = None, 
                       commit_to: Optional[str] = None,
                       json_data: Optional[Dict] = None) -> Tuple[str, str]:
        """
        ...
        logger.info(f"Resolved commits: {resolved_commit_from[:8]}..{resolved_commit_to[:8]}")
    ...
    def get_file_content_at_commit(self, file_path: str, commit_sha: str) -> Optional[str]:
        """
    ...
    def get_file_diff(self, file_path: str, commit_from: str, commit_to: str) -> Optional[str]:
        """
    ...
    def get_changed_files(self, commit_from: str, commit_to: str) -> List[str]:
        ...
        try:
            ...
            logger.error(f"Cannot get changed files between {commit_from} and {commit_to}")
            return []
    ...
    def extract_commit_from_json(self, json_file_path: str) -> Optional[str]:
        """

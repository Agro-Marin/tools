res.partner.categoryLTER TABLE res_partner_res_partner_category_rel ADD  CONSTRAINT "res_partner_res_partner_category_rel_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."res_partner_category" ("id") ON DELETE CASCADE ON UPDATE CASCADE;""",
